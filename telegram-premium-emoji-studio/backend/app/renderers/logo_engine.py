...
# Assets (templates_tgs*/, fonts/) live under app/assets in the new layout.
...
# NOTE: Telegram-bot-specific keyboard builders (font_choice_kb /
# profile_font_choice_kb) were removed when extracting this engine into the
# web backend. Font metadata is exposed via the /fonts API instead.
